...
from experiments.models import Experiments, Mice
from experiments.test.test_constants import \
...
class TestExperimentHelpers(TestCase):
    ...
    def test_complete_experiment(self):
        ...
        self.assertEqual(model_to_dict(experiment)['status'], ExperimentStatuses.Complete.value)
    ...
    def test_pause_experiment(self):
        ...
        self.assertEqual(model_to_dict(experiment)['status'], ExperimentStatuses.Pause.value)
